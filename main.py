...
def run_demo(model, env, model_type: str = 'sb3', render_mode: str = 'human'):
    ...
    # Get base environment for rendering if VecEnv
    base_env = env.envs[0] if is_vec else env
    ...
    if render_mode == "human":
        print("Rendering to pygame window...")
    print("="*60 + "\n")
    
    # Initial render
    if render_mode == "human" and not is_vec:
        base_env.render(mode="human")
    elif render_mode == "human" and is_vec:
        base_env.render(mode="human")
